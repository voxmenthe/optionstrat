...
```
[#__codelineno-3-1](#__codelineno-3-1)COPY --from=ghcr.io/astral-sh/uv:0.9.27 /uv /uvx /bin/
...
```
[#__codelineno-5-1](#__codelineno-5-1)ADD https://astral.sh/uv/0.9.27/install.sh /uv-installer.sh
...
```
[#__codelineno-13-1](#__codelineno-13-1)$ docker run --rm --volume .:/app --volume /app/.venv [...]
...
```
[#__codelineno-14-1](#__codelineno-14-1)services:
[#__codelineno-14-2](#__codelineno-14-2)  example:
[#__codelineno-14-3](#__codelineno-14-3)    build: .
[#__codelineno-14-4](#__codelineno-14-4)
[#__codelineno-14-5](#__codelineno-14-5)    # ...
[#__codelineno-14-6](#__codelineno-14-6)
[#__codelineno-14-7](#__codelineno-14-7)    develop:
[#__codelineno-14-8](#__codelineno-14-8)      # Create a `watch` configuration to update the app
[#__codelineno-14-9](#__codelineno-14-9)      #
[#__codelineno-14-10](#__codelineno-14-10)      watch:
[#__codelineno-14-11](#__codelineno-14-11)        # Sync the working directory with the `/app` directory in the container
[#__codelineno-14-12](#__codelineno-14-12)        - action: sync
[#__codelineno-14-13](#__codelineno-14-13)          path: .
[#__codelineno-14-14](#__codelineno-14-14)          target: /app
[#__codelineno-14-15](#__codelineno-14-15)          # Exclude the project virtual environment
[#__codelineno-14-16](#__codelineno-14-16)          ignore:
[#__codelineno-14-17](#__codelineno-14-17)            - .venv/
[#__codelineno-14-18](#__codelineno-14-18)
[#__codelineno-14-19](#__codelineno-14-19)        # Rebuild the image on changes to the `pyproject.toml`
[#__codelineno-14-20](#__codelineno-14-20)        - action: rebuild
[#__codelineno-14-21](#__codelineno-14-21)          path: ./pyproject.toml
...
```
[#__codelineno-15-1](#__codelineno-15-1)RUN uv python install --compile-bytecode
[#__codelineno-15-2](#__codelineno-15-2)RUN uv sync --compile-bytecode
...
```
[#__codelineno-16-1](#__codelineno-16-1)ENV UV_COMPILE_BYTECODE=1

```

!!! note "Note"

    uv will only compile the standard library of _managed _Python versions during `uv python install `. The distributor of unmanaged Python versions decides if the standard library is pre-compiled. For example, the official `python `image will not have a compiled standard library. 
...
```
[#__codelineno-17-1](#__codelineno-17-1)ENV UV_LINK_MODE=copy
[#__codelineno-17-2](#__codelineno-17-2)
[#__codelineno-17-3](#__codelineno-17-3)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-17-4](#__codelineno-17-4)    uv sync
...
```
[#__codelineno-18-1](#__codelineno-18-1)ENV UV_PYTHON_CACHE_DIR=/root/.cache/uv/python
[#__codelineno-18-2](#__codelineno-18-2)
[#__codelineno-18-3](#__codelineno-18-3)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-18-4](#__codelineno-18-4)    uv python install
...
!!! note "Note"
    ...
    ```
[#__codelineno-19-1](#__codelineno-19-1)ENV UV_CACHE_DIR=/opt/uv-cache/
...
```
[#__codelineno-20-1](#__codelineno-20-1)# Install uv
[#__codelineno-20-2](#__codelineno-20-2)FROM python:3.12-slim
[#__codelineno-20-3](#__codelineno-20-3)COPY --from=ghcr.io/astral-sh/uv:latest /uv /uvx /bin/
[#__codelineno-20-4](#__codelineno-20-4)
[#__codelineno-20-5](#__codelineno-20-5)# Change the working directory to the `app` directory
[#__codelineno-20-6](#__codelineno-20-6)WORKDIR /app
[#__codelineno-20-7](#__codelineno-20-7)
[#__codelineno-20-8](#__codelineno-20-8)# Install dependencies
[#__codelineno-20-9](#__codelineno-20-9)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-20-10](#__codelineno-20-10)    --mount=type=bind,source=uv.lock,target=uv.lock \
[#__codelineno-20-11](#__codelineno-20-11)    --mount=type=bind,source=pyproject.toml,target=pyproject.toml \
[#__codelineno-20-12](#__codelineno-20-12)    uv sync --locked --no-install-project
[#__codelineno-20-13](#__codelineno-20-13)
[#__codelineno-20-14](#__codelineno-20-14)# Copy the project into the image
[#__codelineno-20-15](#__codelineno-20-15)COPY . /app
[#__codelineno-20-16](#__codelineno-20-16)
[#__codelineno-20-17](#__codelineno-20-17)# Sync the project
[#__codelineno-20-18](#__codelineno-20-18)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-20-19](#__codelineno-20-19)    uv sync --locked
...
[#__codelineno-21-5](#__codelineno-21-5)WORKDIR /app
[#__codelineno-21-6](#__codelineno-21-6)
[#__codelineno-21-7](#__codelineno-21-7)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-21-8](#__codelineno-21-8)    --mount=type=bind,source=uv.lock,target=uv.lock \
[#__codelineno-21-9](#__codelineno-21-9)    --mount=type=bind,source=pyproject.toml,target=pyproject.toml \
[#__codelineno-21-10](#__codelineno-21-10)    uv sync --frozen --no-install-workspace
[#__codelineno-21-11](#__codelineno-21-11)
[#__codelineno-21-12](#__codelineno-21-12)COPY . /app
[#__codelineno-21-13](#__codelineno-21-13)
[#__codelineno-21-14](#__codelineno-21-14)RUN --mount=type=cache,target=/root/.cache/uv \
[#__codelineno-21-15](#__codelineno-21-15)    uv sync --locked
...
[#__codelineno-22-15](#__codelineno-22-15)COPY . /app
