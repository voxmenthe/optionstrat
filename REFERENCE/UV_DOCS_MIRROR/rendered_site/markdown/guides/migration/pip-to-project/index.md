...
#### [Importing dependency sources](#importing-dependency-sources)
...
```
[#__codelineno-30-1](#__codelineno-30-1)./path-dep
[#__codelineno-30-2](#__codelineno-30-2)-e ./editable-path-dep
[#__codelineno-30-3](#__codelineno-30-3)git-dep @ git+https://github.com/astral-sh/git-dep

```

uv will map them to [dependency sources](../../../concepts/projects/dependencies/#dependency-sources)in the `[tool.uv.sources] `table of the `pyproject.toml `: 

pyproject.toml 

```
[#__codelineno-31-1](#__codelineno-31-1)[project]
[#__codelineno-31-2](#__codelineno-31-2)dependencies = [
[#__codelineno-31-3](#__codelineno-31-3)    "path-dep",
[#__codelineno-31-4](#__codelineno-31-4)    "editable-path-dep",
[#__codelineno-31-5](#__codelineno-31-5)    "git-dep",
[#__codelineno-31-6](#__codelineno-31-6)]
[#__codelineno-31-7](#__codelineno-31-7)
[#__codelineno-31-8](#__codelineno-31-8)[tool.uv.sources]
[#__codelineno-31-9](#__codelineno-31-9)path-dep = { path = "./path-dep" }
[#__codelineno-31-10](#__codelineno-31-10)editable-path-dep = { path = "./editable-path-dep", editable = true }
[#__codelineno-31-11](#__codelineno-31-11)git-dep = { git = "https://github.com/astral-sh/git-dep" }
...
```
[#__codelineno-32-1](#__codelineno-32-1)$ uv run pytest
