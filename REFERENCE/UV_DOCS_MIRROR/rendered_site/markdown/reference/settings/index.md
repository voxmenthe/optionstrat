...
Including a package as a constraint will _not _trigger installation of the package during a build; instead, the package must be requested elsewhere in the project's build dependency graph. 
...
```
[#__codelineno-0-1](#__codelineno-0-1)[tool.uv]
[#__codelineno-0-2](#__codelineno-0-2)# Ensure that the setuptools v60.0.0 is used whenever a package has a build dependency
[#__codelineno-0-3](#__codelineno-0-3)# on setuptools.
[#__codelineno-0-4](#__codelineno-0-4)build-constraint-dependencies = ["setuptools==60.0.0"]
...
```
[#__codelineno-1-1](#__codelineno-1-1)[tool.uv]
[#__codelineno-1-2](#__codelineno-1-2)# Require that `package[extra1]` and `package[extra2]` are resolved
[#__codelineno-1-3](#__codelineno-1-3)# in different forks so that they cannot conflict with one another.
[#__codelineno-1-4](#__codelineno-1-4)conflicts = [
[#__codelineno-1-5](#__codelineno-1-5)    [
[#__codelineno-1-6](#__codelineno-1-6)        { extra = "extra1" },
[#__codelineno-1-7](#__codelineno-1-7)        { extra = "extra2" },
[#__codelineno-1-8](#__codelineno-1-8)    ]
[#__codelineno-1-9](#__codelineno-1-9)]
[#__codelineno-1-10](#__codelineno-1-10)
[#__codelineno-1-11](#__codelineno-1-11)# Require that the dependency groups `group1` and `group2`
[#__codelineno-1-12](#__codelineno-1-12)# are resolved in different forks so that they cannot conflict
[#__codelineno-1-13](#__codelineno-1-13)# with one another.
[#__codelineno-1-14](#__codelineno-1-14)conflicts = [
[#__codelineno-1-15](#__codelineno-1-15)    [
[#__codelineno-1-16](#__codelineno-1-16)        { group = "group1" },
[#__codelineno-1-17](#__codelineno-1-17)        { group = "group2" },
[#__codelineno-1-18](#__codelineno-1-18)    ]
[#__codelineno-1-19](#__codelineno-1-19)]
...
Including a package as a constraint will _not _trigger installation of the package on its own; instead, the package must be requested elsewhere in the project's first-party or transitive dependencies. 
...
```
[#__codelineno-2-1](#__codelineno-2-1)[tool.uv]
[#__codelineno-2-2](#__codelineno-2-2)# Ensure that the grpcio version is always less than 1.65, if it's requested by a
[#__codelineno-2-3](#__codelineno-2-3)# direct or transitive dependency.
[#__codelineno-2-4](#__codelineno-2-4)constraint-dependencies = ["grpcio<1.65"]
...
```
[#__codelineno-3-1](#__codelineno-3-1)[tool.uv]
[#__codelineno-3-2](#__codelineno-3-2)default-groups = ["docs"]
...
```
[#__codelineno-4-1](#__codelineno-4-1)[tool.uv.dependency-groups]
[#__codelineno-4-2](#__codelineno-4-2)my-group = {requires-python = ">=3.12"}
...
```
[#__codelineno-5-1](#__codelineno-5-1)[tool.uv]
[#__codelineno-5-2](#__codelineno-5-2)dev-dependencies = ["ruff==0.5.0"]
...
```
[#__codelineno-6-1](#__codelineno-6-1)[tool.uv]
[#__codelineno-6-2](#__codelineno-6-2)# Resolve for macOS, but not for Linux or Windows.
[#__codelineno-6-3](#__codelineno-6-3)environments = ["sys_platform == 'darwin'"]
...
```
[#__codelineno-7-1](#__codelineno-7-1)[tool.uv]
[#__codelineno-7-2](#__codelineno-7-2)# Exclude Werkzeug from being installed, even if transitive dependencies request it.
[#__codelineno-7-3](#__codelineno-7-3)exclude-dependencies = ["werkzeug"]
...
[#__codelineno-8-2](#__codelineno-8-2)name = "pytorch"
[#__codelineno-8-3](#__codelineno-8-3)url = "https://download.pytorch.org/whl/cu121"
[#__codelineno-8-4](#__codelineno-8-4)explicit = true
[#__codelineno-8-5](#__codelineno-8-5)
[#__codelineno-8-6](#__codelineno-8-6)[tool.uv.sources]
[#__codelineno-8-7](#__codelineno-8-7)torch = { index = "pytorch" }
...
[#__codelineno-9-2](#__codelineno-9-2)name = "pytorch"
[#__codelineno-9-3](#__codelineno-9-3)url = "https://download.pytorch.org/whl/cu121"
...
```
[#__codelineno-10-1](#__codelineno-10-1)[tool.uv]
[#__codelineno-10-2](#__codelineno-10-2)managed = false
...
While constraints are _additive _, in that they're combined with the requirements of the constituent packages, overrides are _absolute _, in that they completely replace the requirements of any constituent packages. 

Including a package as an override will _not _trigger installation of the package on its own; instead, the package must be requested elsewhere in the project's first-party or transitive dependencies. 
...
[#__codelineno-11-2](#__codelineno-11-2)# Always install Werkzeug 2.3.0, regardless of whether transitive dependencies request
[#__codelineno-11-3](#__codelineno-11-3)# a different version.
[#__codelineno-11-4](#__codelineno-11-4)override-dependencies = ["werkzeug==2.3.0"]
...
Packages are built and installed into the virtual environment in editable mode and thus require a build backend, while virtual projects are _not _built or installed; instead, only their dependencies are included in the virtual environment. 
...
```
[#__codelineno-12-1](#__codelineno-12-1)[tool.uv]
[#__codelineno-12-2](#__codelineno-12-2)package = false
...
While the `environments `setting _limits _the set of environments that uv will consider when resolving dependencies, `required-environments `_expands _the set of platforms that uv _must _support when resolving dependencies. 

For example, `environments = ["sys_platform == 'darwin'"] `would limit uv to solving for macOS (and ignoring Linux and Windows). On the other hand, `required-environments = ["sys_platform == 'darwin'"] `would _require _that any package without a source distribution include a wheel for macOS in order to be installable. 
...
```
[#__codelineno-13-1](#__codelineno-13-1)[tool.uv]
[#__codelineno-13-2](#__codelineno-13-2)# Require that the package is available for macOS ARM and x86 (Intel).
[#__codelineno-13-3](#__codelineno-13-3)required-environments = [
[#__codelineno-13-4](#__codelineno-13-4)    "sys_platform == 'darwin' and platform_machine == 'arm64'",
[#__codelineno-13-5](#__codelineno-13-5)    "sys_platform == 'darwin' and platform_machine == 'x86_64'",
...
[#__codelineno-14-2](#__codelineno-14-2)httpx = { git = "https://github.com/encode/httpx", tag = "0.27.0" }
[#__codelineno-14-3](#__codelineno-14-3)pytest = { url = "https://files.pythonhosted.org/packages/6b/77/7440a06a8ead44c7757a64362dd22df5760f9b12dc5f11b6188cd2fc27a0/pytest-8.3.3-py3-none-any.whl" }
[#__codelineno-14-4](#__codelineno-14-4)pydantic = { path = "/path/to/pydantic", editable = true }
...
```
[#__codelineno-15-1](#__codelineno-15-1)[tool.uv.build-backend]
[#__codelineno-15-2](#__codelineno-15-2)data = { headers = "include/headers", scripts = "bin" }
...
```
[#__codelineno-16-1](#__codelineno-16-1)[tool.uv.build-backend]
[#__codelineno-16-2](#__codelineno-16-2)default-excludes = false
...
```
[#__codelineno-17-1](#__codelineno-17-1)[tool.uv.build-backend]
[#__codelineno-17-2](#__codelineno-17-2)module-name = "sklearn"
...
```
[#__codelineno-18-1](#__codelineno-18-1)[tool.uv.build-backend]
[#__codelineno-18-2](#__codelineno-18-2)module-root = ""
...
```
[#__codelineno-19-1](#__codelineno-19-1)src
[#__codelineno-19-2](#__codelineno-19-2)└── cloud
[#__codelineno-19-3](#__codelineno-19-3)    └── database
[#__codelineno-19-4](#__codelineno-19-4)        ├── __init__.py
[#__codelineno-19-5](#__codelineno-19-5)        ├── query_builder
[#__codelineno-19-6](#__codelineno-19-6)        │   └── __init__.py
[#__codelineno-19-7](#__codelineno-19-7)        └── sql
[#__codelineno-19-8](#__codelineno-19-8)            ├── parser.py
[#__codelineno-19-9](#__codelineno-19-9)            └── __init__.py

```

```
[#__codelineno-20-1](#__codelineno-20-1)src
[#__codelineno-20-2](#__codelineno-20-2)├── cloud
[#__codelineno-20-3](#__codelineno-20-3)│   ├── database
[#__codelineno-20-4](#__codelineno-20-4)│   │   ├── __init__.py
[#__codelineno-20-5](#__codelineno-20-5)│   │   ├── query_builder
[#__codelineno-20-6](#__codelineno-20-6)│   │   │   └── __init__.py
[#__codelineno-20-7](#__codelineno-20-7)│   │   └── sql
[#__codelineno-20-8](#__codelineno-20-8)│   │       ├── __init__.py
[#__codelineno-20-9](#__codelineno-20-9)│   │       └── parser.py
[#__codelineno-20-10](#__codelineno-20-10)│   └── database_pro
[#__codelineno-20-11](#__codelineno-20-11)│       ├── __init__.py
[#__codelineno-20-12](#__codelineno-20-12)│       └── query_builder.py
[#__codelineno-20-13](#__codelineno-20-13)└── billing
[#__codelineno-20-14](#__codelineno-20-14)    └── modules
[#__codelineno-20-15](#__codelineno-20-15)        └── database_pro
[#__codelineno-20-16](#__codelineno-20-16)            ├── __init__.py
[#__codelineno-20-17](#__codelineno-20-17)            └── sql.py
...
```
[#__codelineno-21-1](#__codelineno-21-1)[tool.uv.build-backend]
[#__codelineno-21-2](#__codelineno-21-2)namespace = true
...
```
[#__codelineno-22-1](#__codelineno-22-1)[tool.uv.build-backend]
[#__codelineno-22-2](#__codelineno-22-2)source-exclude = ["*.bin"]
...
```
[#__codelineno-23-1](#__codelineno-23-1)[tool.uv.build-backend]
[#__codelineno-23-2](#__codelineno-23-2)source-include = ["tests/**"]
...
```
[#__codelineno-24-1](#__codelineno-24-1)[tool.uv.build-backend]
[#__codelineno-24-2](#__codelineno-24-2)wheel-exclude = ["*.bin"]
...
```
[#__codelineno-25-1](#__codelineno-25-1)[tool.uv.workspace]
[#__codelineno-25-2](#__codelineno-25-2)exclude = ["member1", "path/to/member2", "libs/*"]
...
```
[#__codelineno-26-1](#__codelineno-26-1)[tool.uv.workspace]
[#__codelineno-26-2](#__codelineno-26-2)members = ["member1", "path/to/member2", "libs/*"]
...
```
[#__codelineno-27-1](#__codelineno-27-1)[tool.uv]
[#__codelineno-27-2](#__codelineno-27-2)add-bounds = "major"
...
```
[#__codelineno-28-1](#__codelineno-28-1)add-bounds = "major"
...
```
[#__codelineno-29-1](#__codelineno-29-1)[tool.uv]
[#__codelineno-29-2](#__codelineno-29-2)allow-insecure-host = ["localhost:8080"]
...
```
[#__codelineno-30-1](#__codelineno-30-1)allow-insecure-host = ["localhost:8080"]
...
```
[#__codelineno-31-1](#__codelineno-31-1)cache-dir = "./.uv_cache"
...
```
[#__codelineno-32-1](#__codelineno-32-1)cache-keys = [{ file = "pyproject.toml" }, { file = "setup.py" }, { file = "setup.cfg" }, { dir = "src" }]
...
```
[#__codelineno-33-1](#__codelineno-33-1)[tool.uv]
[#__codelineno-33-2](#__codelineno-33-2)cache-keys = [{ file = "pyproject.toml" }, { file = "requirements.txt" }, { git = { commit = true } }]
...
```
[#__codelineno-34-1](#__codelineno-34-1)cache-keys = [{ file = "pyproject.toml" }, { file = "requirements.txt" }, { git = { commit = true } }]
...
```
[#__codelineno-35-1](#__codelineno-35-1)[tool.uv]
[#__codelineno-35-2](#__codelineno-35-2)check-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-36-1](#__codelineno-36-1)check-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-37-1](#__codelineno-37-1)[tool.uv]
[#__codelineno-37-2](#__codelineno-37-2)compile-bytecode = true
...
```
[#__codelineno-38-1](#__codelineno-38-1)compile-bytecode = true
...
```
[#__codelineno-39-1](#__codelineno-39-1)[tool.uv]
[#__codelineno-39-2](#__codelineno-39-2)concurrent-builds = 4
...
```
[#__codelineno-40-1](#__codelineno-40-1)concurrent-builds = 4
...
```
[#__codelineno-41-1](#__codelineno-41-1)[tool.uv]
[#__codelineno-41-2](#__codelineno-41-2)concurrent-downloads = 4
...
```
[#__codelineno-42-1](#__codelineno-42-1)concurrent-downloads = 4
...
```
[#__codelineno-43-1](#__codelineno-43-1)[tool.uv]
[#__codelineno-43-2](#__codelineno-43-2)concurrent-installs = 4
...
```
[#__codelineno-44-1](#__codelineno-44-1)concurrent-installs = 4
...
```
[#__codelineno-45-1](#__codelineno-45-1)[tool.uv]
[#__codelineno-45-2](#__codelineno-45-2)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-46-1](#__codelineno-46-1)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-47-1](#__codelineno-47-1)[tool.uv]
[#__codelineno-47-2](#__codelineno-47-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
```
[#__codelineno-48-1](#__codelineno-48-1)config-settings-package = { numpy = { editable_mode = "compat" } }
...
```
[#__codelineno-49-1](#__codelineno-49-1)[tool.uv]
[#__codelineno-49-2](#__codelineno-49-2)dependency-metadata = [
[#__codelineno-49-3](#__codelineno-49-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-49-4](#__codelineno-49-4)]
...
```
[#__codelineno-50-1](#__codelineno-50-1)dependency-metadata = [
[#__codelineno-50-2](#__codelineno-50-2)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-50-3](#__codelineno-50-3)]
...
[#__codelineno-51-2](#__codelineno-51-2)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[#__codelineno-52-1](#__codelineno-52-1)exclude-newer = "2006-12-02T02:07:43Z"
...
[#__codelineno-53-2](#__codelineno-53-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
```
[#__codelineno-54-1](#__codelineno-54-1)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
[#__codelineno-55-2](#__codelineno-55-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-56-1](#__codelineno-56-1)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-57-1](#__codelineno-57-1)[tool.uv]
[#__codelineno-57-2](#__codelineno-57-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-58-1](#__codelineno-58-1)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-59-1](#__codelineno-59-1)[tool.uv]
[#__codelineno-59-2](#__codelineno-59-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-60-1](#__codelineno-60-1)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-61-1](#__codelineno-61-1)[tool.uv]
[#__codelineno-61-2](#__codelineno-61-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-62-1](#__codelineno-62-1)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-63-1](#__codelineno-63-1)[tool.uv]
[#__codelineno-63-2](#__codelineno-63-2)fork-strategy = "fewest"
...
```
[#__codelineno-64-1](#__codelineno-64-1)fork-strategy = "fewest"
...
```
[#__codelineno-65-1](#__codelineno-65-1)http-proxy = "http://proxy.example.com"
...
```
[#__codelineno-66-1](#__codelineno-66-1)https-proxy = "https://proxy.example.com"
...
```
[#__codelineno-67-1](#__codelineno-67-1)[[tool.uv.index]]
[#__codelineno-67-2](#__codelineno-67-2)name = "pytorch"
[#__codelineno-67-3](#__codelineno-67-3)url = "https://download.pytorch.org/whl/cu121"
[#__codelineno-67-4](#__codelineno-67-4)explicit = true
[#__codelineno-67-5](#__codelineno-67-5)
[#__codelineno-67-6](#__codelineno-67-6)[tool.uv.sources]
[#__codelineno-67-7](#__codelineno-67-7)torch = { index = "pytorch" }
...
```
[#__codelineno-68-1](#__codelineno-68-1)[[tool.uv.index]]
[#__codelineno-68-2](#__codelineno-68-2)name = "pytorch"
[#__codelineno-68-3](#__codelineno-68-3)url = "https://download.pytorch.org/whl/cu121"
...
```
[#__codelineno-69-1](#__codelineno-69-1)[[tool.uv.index]]
[#__codelineno-69-2](#__codelineno-69-2)name = "pytorch"
[#__codelineno-69-3](#__codelineno-69-3)url = "https://download.pytorch.org/whl/cu121"
...
```
[#__codelineno-70-1](#__codelineno-70-1)[tool.uv]
[#__codelineno-70-2](#__codelineno-70-2)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-71-1](#__codelineno-71-1)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-72-1](#__codelineno-72-1)[tool.uv]
[#__codelineno-72-2](#__codelineno-72-2)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-73-1](#__codelineno-73-1)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-74-1](#__codelineno-74-1)[tool.uv]
[#__codelineno-74-2](#__codelineno-74-2)keyring-provider = "subprocess"
...
```
[#__codelineno-75-1](#__codelineno-75-1)keyring-provider = "subprocess"
...
```
[#__codelineno-76-1](#__codelineno-76-1)[tool.uv]
[#__codelineno-76-2](#__codelineno-76-2)link-mode = "copy"
...
```
[#__codelineno-77-1](#__codelineno-77-1)link-mode = "copy"
...
```
[#__codelineno-78-1](#__codelineno-78-1)native-tls = true
...
```
[#__codelineno-79-1](#__codelineno-79-1)[tool.uv]
[#__codelineno-79-2](#__codelineno-79-2)no-binary = true
...
```
[#__codelineno-80-1](#__codelineno-80-1)no-binary = true
...
```
[#__codelineno-81-1](#__codelineno-81-1)[tool.uv]
[#__codelineno-81-2](#__codelineno-81-2)no-binary-package = ["ruff"]
...
```
[#__codelineno-82-1](#__codelineno-82-1)no-binary-package = ["ruff"]
...
```
[#__codelineno-83-1](#__codelineno-83-1)[tool.uv]
[#__codelineno-83-2](#__codelineno-83-2)no-build = true
...
```
[#__codelineno-84-1](#__codelineno-84-1)no-build = true
...
```
[#__codelineno-85-1](#__codelineno-85-1)[tool.uv]
[#__codelineno-85-2](#__codelineno-85-2)no-build-isolation = true
...
```
[#__codelineno-86-1](#__codelineno-86-1)no-build-isolation = true
...
```
[#__codelineno-87-1](#__codelineno-87-1)[tool.uv]
[#__codelineno-87-2](#__codelineno-87-2)no-build-isolation-package = ["package1", "package2"]
...
```
[#__codelineno-88-1](#__codelineno-88-1)no-build-isolation-package = ["package1", "package2"]
...
```
[#__codelineno-89-1](#__codelineno-89-1)[tool.uv]
[#__codelineno-89-2](#__codelineno-89-2)no-build-package = ["ruff"]
...
```
[#__codelineno-90-1](#__codelineno-90-1)no-build-package = ["ruff"]
...
```
[#__codelineno-91-1](#__codelineno-91-1)[tool.uv]
[#__codelineno-91-2](#__codelineno-91-2)no-cache = true
...
```
[#__codelineno-92-1](#__codelineno-92-1)no-cache = true
...
```
[#__codelineno-93-1](#__codelineno-93-1)[tool.uv]
[#__codelineno-93-2](#__codelineno-93-2)no-index = true
...
```
[#__codelineno-94-1](#__codelineno-94-1)no-index = true
...
```
[#__codelineno-95-1](#__codelineno-95-1)no-proxy = ["localhost", "127.0.0.1"]
...
```
[#__codelineno-96-1](#__codelineno-96-1)[tool.uv]
[#__codelineno-96-2](#__codelineno-96-2)no-sources = true
...
```
[#__codelineno-97-1](#__codelineno-97-1)no-sources = true
...
```
[#__codelineno-98-1](#__codelineno-98-1)[tool.uv]
[#__codelineno-98-2](#__codelineno-98-2)no-sources-package = ["ruff"]
...
```
[#__codelineno-99-1](#__codelineno-99-1)no-sources-package = ["ruff"]
...
```
[#__codelineno-100-1](#__codelineno-100-1)[tool.uv]
[#__codelineno-100-2](#__codelineno-100-2)offline = true
...
```
[#__codelineno-101-1](#__codelineno-101-1)offline = true
...
By default, uv will accept pre-releases for packages that _only _publish pre-releases, along with first-party requirements that contain an explicit pre-release marker in the declared specifiers ( `if-necessary-or-explicit `). 
...
```
[#__codelineno-102-1](#__codelineno-102-1)[tool.uv]
[#__codelineno-102-2](#__codelineno-102-2)prerelease = "allow"
...
```
[#__codelineno-103-1](#__codelineno-103-1)prerelease = "allow"
...
```
[#__codelineno-104-1](#__codelineno-104-1)[tool.uv]
[#__codelineno-104-2](#__codelineno-104-2)preview = true
...
```
[#__codelineno-105-1](#__codelineno-105-1)preview = true
...
```
[#__codelineno-106-1](#__codelineno-106-1)[tool.uv]
[#__codelineno-106-2](#__codelineno-106-2)publish-url = "https://test.pypi.org/legacy/"
...
```
[#__codelineno-107-1](#__codelineno-107-1)publish-url = "https://test.pypi.org/legacy/"
...
```
[#__codelineno-108-1](#__codelineno-108-1)pypy-install-mirror = "https://downloads.python.org/pypy"
...
```
[#__codelineno-109-1](#__codelineno-109-1)[tool.uv]
[#__codelineno-109-2](#__codelineno-109-2)python-downloads = "manual"
...
```
[#__codelineno-110-1](#__codelineno-110-1)python-downloads = "manual"
...
```
[#__codelineno-111-1](#__codelineno-111-1)python-downloads-json-url = "/etc/uv/python-downloads.json"
...
```
[#__codelineno-112-1](#__codelineno-112-1)python-install-mirror = "https://github.com/astral-sh/python-build-standalone/releases/download"
...
```
[#__codelineno-113-1](#__codelineno-113-1)[tool.uv]
[#__codelineno-113-2](#__codelineno-113-2)python-preference = "managed"
...
```
[#__codelineno-114-1](#__codelineno-114-1)python-preference = "managed"
...
```
[#__codelineno-115-1](#__codelineno-115-1)[tool.uv]
[#__codelineno-115-2](#__codelineno-115-2)reinstall = true
...
```
[#__codelineno-116-1](#__codelineno-116-1)reinstall = true
...
```
[#__codelineno-117-1](#__codelineno-117-1)[tool.uv]
[#__codelineno-117-2](#__codelineno-117-2)reinstall-package = ["ruff"]
...
```
[#__codelineno-118-1](#__codelineno-118-1)reinstall-package = ["ruff"]
...
```
[#__codelineno-119-1](#__codelineno-119-1)[tool.uv]
[#__codelineno-119-2](#__codelineno-119-2)required-version = ">=0.5.0"
...
```
[#__codelineno-120-1](#__codelineno-120-1)required-version = ">=0.5.0"
...
```
[#__codelineno-121-1](#__codelineno-121-1)[tool.uv]
[#__codelineno-121-2](#__codelineno-121-2)resolution = "lowest-direct"
...
```
[#__codelineno-122-1](#__codelineno-122-1)resolution = "lowest-direct"
...
```
[#__codelineno-123-1](#__codelineno-123-1)[tool.uv]
[#__codelineno-123-2](#__codelineno-123-2)torch-backend = "auto"
...
```
[#__codelineno-124-1](#__codelineno-124-1)torch-backend = "auto"
...
```
[#__codelineno-125-1](#__codelineno-125-1)[tool.uv]
[#__codelineno-125-2](#__codelineno-125-2)trusted-publishing = "always"
...
```
[#__codelineno-126-1](#__codelineno-126-1)trusted-publishing = "always"
...
```
[#__codelineno-127-1](#__codelineno-127-1)[tool.uv]
[#__codelineno-127-2](#__codelineno-127-2)upgrade = true
...
```
[#__codelineno-128-1](#__codelineno-128-1)upgrade = true
...
```
[#__codelineno-129-1](#__codelineno-129-1)[tool.uv]
[#__codelineno-129-2](#__codelineno-129-2)upgrade-package = ["ruff"]
...
```
[#__codelineno-130-1](#__codelineno-130-1)upgrade-package = ["ruff"]
...
```
[#__codelineno-131-1](#__codelineno-131-1)[tool.uv.pip]
[#__codelineno-131-2](#__codelineno-131-2)all-extras = true
...
```
[#__codelineno-132-1](#__codelineno-132-1)[pip]
[#__codelineno-132-2](#__codelineno-132-2)all-extras = true
...
```
[#__codelineno-133-1](#__codelineno-133-1)[tool.uv.pip]
[#__codelineno-133-2](#__codelineno-133-2)allow-empty-requirements = true
...
```
[#__codelineno-134-1](#__codelineno-134-1)[pip]
[#__codelineno-134-2](#__codelineno-134-2)allow-empty-requirements = true
...
```
[#__codelineno-135-1](#__codelineno-135-1)[tool.uv.pip]
[#__codelineno-135-2](#__codelineno-135-2)annotation-style = "line"
...
```
[#__codelineno-136-1](#__codelineno-136-1)[pip]
[#__codelineno-136-2](#__codelineno-136-2)annotation-style = "line"
...
```
[#__codelineno-137-1](#__codelineno-137-1)[tool.uv.pip]
[#__codelineno-137-2](#__codelineno-137-2)break-system-packages = true
...
```
[#__codelineno-138-1](#__codelineno-138-1)[pip]
[#__codelineno-138-2](#__codelineno-138-2)break-system-packages = true
...
```
[#__codelineno-139-1](#__codelineno-139-1)[tool.uv.pip]
[#__codelineno-139-2](#__codelineno-139-2)compile-bytecode = true
...
```
[#__codelineno-140-1](#__codelineno-140-1)[pip]
[#__codelineno-140-2](#__codelineno-140-2)compile-bytecode = true
...
```
[#__codelineno-141-1](#__codelineno-141-1)[tool.uv.pip]
[#__codelineno-141-2](#__codelineno-141-2)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-142-1](#__codelineno-142-1)[pip]
[#__codelineno-142-2](#__codelineno-142-2)config-settings = { editable_mode = "compat" }
...
```
[#__codelineno-143-1](#__codelineno-143-1)[tool.uv.pip]
[#__codelineno-143-2](#__codelineno-143-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
```
[#__codelineno-144-1](#__codelineno-144-1)[pip]
[#__codelineno-144-2](#__codelineno-144-2)config-settings-package = { numpy = { editable_mode = "compat" } }
...
```
[#__codelineno-145-1](#__codelineno-145-1)[tool.uv.pip]
[#__codelineno-145-2](#__codelineno-145-2)custom-compile-command = "./custom-uv-compile.sh"
...
```
[#__codelineno-146-1](#__codelineno-146-1)[pip]
[#__codelineno-146-2](#__codelineno-146-2)custom-compile-command = "./custom-uv-compile.sh"
...
```
[#__codelineno-147-1](#__codelineno-147-1)[tool.uv.pip]
[#__codelineno-147-2](#__codelineno-147-2)dependency-metadata = [
[#__codelineno-147-3](#__codelineno-147-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-147-4](#__codelineno-147-4)]
...
```
[#__codelineno-148-1](#__codelineno-148-1)[pip]
[#__codelineno-148-2](#__codelineno-148-2)dependency-metadata = [
[#__codelineno-148-3](#__codelineno-148-3)    { name = "flask", version = "1.0.0", requires-dist = ["werkzeug"], requires-python = ">=3.6" },
[#__codelineno-148-4](#__codelineno-148-4)]
...
```
[#__codelineno-149-1](#__codelineno-149-1)[tool.uv.pip]
[#__codelineno-149-2](#__codelineno-149-2)emit-build-options = true
...
```
[#__codelineno-150-1](#__codelineno-150-1)[pip]
[#__codelineno-150-2](#__codelineno-150-2)emit-build-options = true
...
```
[#__codelineno-151-1](#__codelineno-151-1)[tool.uv.pip]
[#__codelineno-151-2](#__codelineno-151-2)emit-find-links = true
...
```
[#__codelineno-152-1](#__codelineno-152-1)[pip]
[#__codelineno-152-2](#__codelineno-152-2)emit-find-links = true
...
```
[#__codelineno-153-1](#__codelineno-153-1)[tool.uv.pip]
[#__codelineno-153-2](#__codelineno-153-2)emit-index-annotation = true
...
```
[#__codelineno-154-1](#__codelineno-154-1)[pip]
[#__codelineno-154-2](#__codelineno-154-2)emit-index-annotation = true
...
```
[#__codelineno-155-1](#__codelineno-155-1)[tool.uv.pip]
[#__codelineno-155-2](#__codelineno-155-2)emit-index-url = true
...
```
[#__codelineno-156-1](#__codelineno-156-1)[pip]
[#__codelineno-156-2](#__codelineno-156-2)emit-index-url = true
...
```
[#__codelineno-157-1](#__codelineno-157-1)[tool.uv.pip]
[#__codelineno-157-2](#__codelineno-157-2)emit-marker-expression = true
...
```
[#__codelineno-158-1](#__codelineno-158-1)[pip]
[#__codelineno-158-2](#__codelineno-158-2)emit-marker-expression = true
...
```
[#__codelineno-159-1](#__codelineno-159-1)[tool.uv.pip]
[#__codelineno-159-2](#__codelineno-159-2)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[#__codelineno-160-1](#__codelineno-160-1)[pip]
[#__codelineno-160-2](#__codelineno-160-2)exclude-newer = "2006-12-02T02:07:43Z"
...
```
[#__codelineno-161-1](#__codelineno-161-1)[tool.uv.pip]
[#__codelineno-161-2](#__codelineno-161-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
```
[#__codelineno-162-1](#__codelineno-162-1)[pip]
[#__codelineno-162-2](#__codelineno-162-2)exclude-newer-package = { tqdm = "2022-04-04T00:00:00Z" }
...
```
[#__codelineno-163-1](#__codelineno-163-1)[tool.uv.pip]
[#__codelineno-163-2](#__codelineno-163-2)extra = ["dev", "docs"]
...
```
[#__codelineno-164-1](#__codelineno-164-1)[pip]
[#__codelineno-164-2](#__codelineno-164-2)extra = ["dev", "docs"]
...
```
[#__codelineno-165-1](#__codelineno-165-1)[tool.uv.pip]
[#__codelineno-165-2](#__codelineno-165-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-166-1](#__codelineno-166-1)[pip]
[#__codelineno-166-2](#__codelineno-166-2)extra-build-dependencies = { pytest = ["setuptools"] }
...
```
[#__codelineno-167-1](#__codelineno-167-1)[tool.uv.pip]
[#__codelineno-167-2](#__codelineno-167-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-168-1](#__codelineno-168-1)[pip]
[#__codelineno-168-2](#__codelineno-168-2)extra-build-variables = { flash-attn = { FLASH_ATTENTION_SKIP_CUDA_BUILD = "TRUE" } }
...
```
[#__codelineno-169-1](#__codelineno-169-1)[tool.uv.pip]
[#__codelineno-169-2](#__codelineno-169-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-170-1](#__codelineno-170-1)[pip]
[#__codelineno-170-2](#__codelineno-170-2)extra-index-url = ["https://download.pytorch.org/whl/cpu"]
...
```
[#__codelineno-171-1](#__codelineno-171-1)[tool.uv.pip]
[#__codelineno-171-2](#__codelineno-171-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-172-1](#__codelineno-172-1)[pip]
[#__codelineno-172-2](#__codelineno-172-2)find-links = ["https://download.pytorch.org/whl/torch_stable.html"]
...
```
[#__codelineno-173-1](#__codelineno-173-1)[tool.uv.pip]
[#__codelineno-173-2](#__codelineno-173-2)fork-strategy = "fewest"
...
```
[#__codelineno-174-1](#__codelineno-174-1)[pip]
[#__codelineno-174-2](#__codelineno-174-2)fork-strategy = "fewest"
...
```
[#__codelineno-175-1](#__codelineno-175-1)[tool.uv.pip]
[#__codelineno-175-2](#__codelineno-175-2)generate-hashes = true
...
```
[#__codelineno-176-1](#__codelineno-176-1)[pip]
[#__codelineno-176-2](#__codelineno-176-2)generate-hashes = true
...
```
[#__codelineno-177-1](#__codelineno-177-1)[tool.uv.pip]
[#__codelineno-177-2](#__codelineno-177-2)group = ["dev", "docs"]
...
```
[#__codelineno-178-1](#__codelineno-178-1)[pip]
[#__codelineno-178-2](#__codelineno-178-2)group = ["dev", "docs"]
...
```
[#__codelineno-179-1](#__codelineno-179-1)[tool.uv.pip]
[#__codelineno-179-2](#__codelineno-179-2)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-180-1](#__codelineno-180-1)[pip]
[#__codelineno-180-2](#__codelineno-180-2)index-strategy = "unsafe-best-match"
...
```
[#__codelineno-181-1](#__codelineno-181-1)[tool.uv.pip]
[#__codelineno-181-2](#__codelineno-181-2)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-182-1](#__codelineno-182-1)[pip]
[#__codelineno-182-2](#__codelineno-182-2)index-url = "https://test.pypi.org/simple"
...
```
[#__codelineno-183-1](#__codelineno-183-1)[tool.uv.pip]
[#__codelineno-183-2](#__codelineno-183-2)keyring-provider = "subprocess"
...
```
[#__codelineno-184-1](#__codelineno-184-1)[pip]
[#__codelineno-184-2](#__codelineno-184-2)keyring-provider = "subprocess"
...
```
[#__codelineno-185-1](#__codelineno-185-1)[tool.uv.pip]
[#__codelineno-185-2](#__codelineno-185-2)link-mode = "copy"
...
```
[#__codelineno-186-1](#__codelineno-186-1)[pip]
[#__codelineno-186-2](#__codelineno-186-2)link-mode = "copy"
...
```
[#__codelineno-187-1](#__codelineno-187-1)[tool.uv.pip]
[#__codelineno-187-2](#__codelineno-187-2)no-annotate = true
...
```
[#__codelineno-188-1](#__codelineno-188-1)[pip]
[#__codelineno-188-2](#__codelineno-188-2)no-annotate = true
...
```
[#__codelineno-189-1](#__codelineno-189-1)[tool.uv.pip]
[#__codelineno-189-2](#__codelineno-189-2)no-binary = ["ruff"]
...
```
[#__codelineno-190-1](#__codelineno-190-1)[pip]
[#__codelineno-190-2](#__codelineno-190-2)no-binary = ["ruff"]
...
```
[#__codelineno-191-1](#__codelineno-191-1)[tool.uv.pip]
[#__codelineno-191-2](#__codelineno-191-2)no-build = true
...
```
[#__codelineno-192-1](#__codelineno-192-1)[pip]
[#__codelineno-192-2](#__codelineno-192-2)no-build = true
...
```
[#__codelineno-193-1](#__codelineno-193-1)[tool.uv.pip]
[#__codelineno-193-2](#__codelineno-193-2)no-build-isolation = true
...
```
[#__codelineno-194-1](#__codelineno-194-1)[pip]
[#__codelineno-194-2](#__codelineno-194-2)no-build-isolation = true
...
```
[#__codelineno-195-1](#__codelineno-195-1)[tool.uv.pip]
[#__codelineno-195-2](#__codelineno-195-2)no-build-isolation-package = ["package1", "package2"]
...
```
[#__codelineno-196-1](#__codelineno-196-1)[pip]
[#__codelineno-196-2](#__codelineno-196-2)no-build-isolation-package = ["package1", "package2"]
...
```
[#__codelineno-197-1](#__codelineno-197-1)[tool.uv.pip]
[#__codelineno-197-2](#__codelineno-197-2)no-deps = true
...
```
[#__codelineno-198-1](#__codelineno-198-1)[pip]
[#__codelineno-198-2](#__codelineno-198-2)no-deps = true
...
```
[#__codelineno-199-1](#__codelineno-199-1)[tool.uv.pip]
[#__codelineno-199-2](#__codelineno-199-2)no-emit-package = ["ruff"]
...
```
[#__codelineno-200-1](#__codelineno-200-1)[pip]
[#__codelineno-200-2](#__codelineno-200-2)no-emit-package = ["ruff"]
...
```
[#__codelineno-201-1](#__codelineno-201-1)[tool.uv.pip]
[#__codelineno-201-2](#__codelineno-201-2)all-extras = true
[#__codelineno-201-3](#__codelineno-201-3)no-extra = ["dev", "docs"]
...
```
[#__codelineno-202-1](#__codelineno-202-1)[pip]
[#__codelineno-202-2](#__codelineno-202-2)all-extras = true
[#__codelineno-202-3](#__codelineno-202-3)no-extra = ["dev", "docs"]
...
```
[#__codelineno-203-1](#__codelineno-203-1)[tool.uv.pip]
[#__codelineno-203-2](#__codelineno-203-2)no-header = true
...
```
[#__codelineno-204-1](#__codelineno-204-1)[pip]
[#__codelineno-204-2](#__codelineno-204-2)no-header = true
...
```
[#__codelineno-205-1](#__codelineno-205-1)[tool.uv.pip]
[#__codelineno-205-2](#__codelineno-205-2)no-index = true
...
```
[#__codelineno-206-1](#__codelineno-206-1)[pip]
[#__codelineno-206-2](#__codelineno-206-2)no-index = true
...
```
[#__codelineno-207-1](#__codelineno-207-1)[tool.uv.pip]
[#__codelineno-207-2](#__codelineno-207-2)no-sources = true
...
```
[#__codelineno-208-1](#__codelineno-208-1)[pip]
[#__codelineno-208-2](#__codelineno-208-2)no-sources = true
...
```
[#__codelineno-209-1](#__codelineno-209-1)[tool.uv.pip]
[#__codelineno-209-2](#__codelineno-209-2)no-sources-package = ["ruff"]
...
```
[#__codelineno-210-1](#__codelineno-210-1)[pip]
[#__codelineno-210-2](#__codelineno-210-2)no-sources-package = ["ruff"]
...
```
[#__codelineno-211-1](#__codelineno-211-1)[tool.uv.pip]
[#__codelineno-211-2](#__codelineno-211-2)no-strip-extras = true
...
```
[#__codelineno-212-1](#__codelineno-212-1)[pip]
[#__codelineno-212-2](#__codelineno-212-2)no-strip-extras = true
...
```
[#__codelineno-213-1](#__codelineno-213-1)[tool.uv.pip]
[#__codelineno-213-2](#__codelineno-213-2)no-strip-markers = true
...
```
[#__codelineno-214-1](#__codelineno-214-1)[pip]
[#__codelineno-214-2](#__codelineno-214-2)no-strip-markers = true
...
```
[#__codelineno-215-1](#__codelineno-215-1)[tool.uv.pip]
[#__codelineno-215-2](#__codelineno-215-2)only-binary = ["ruff"]
...
```
[#__codelineno-216-1](#__codelineno-216-1)[pip]
[#__codelineno-216-2](#__codelineno-216-2)only-binary = ["ruff"]
...
```
[#__codelineno-217-1](#__codelineno-217-1)[tool.uv.pip]
[#__codelineno-217-2](#__codelineno-217-2)output-file = "requirements.txt"
...
```
[#__codelineno-218-1](#__codelineno-218-1)[pip]
[#__codelineno-218-2](#__codelineno-218-2)output-file = "requirements.txt"
...
```
[#__codelineno-219-1](#__codelineno-219-1)[tool.uv.pip]
[#__codelineno-219-2](#__codelineno-219-2)prefix = "./prefix"
...
```
[#__codelineno-220-1](#__codelineno-220-1)[pip]
[#__codelineno-220-2](#__codelineno-220-2)prefix = "./prefix"
...
```
[#__codelineno-221-1](#__codelineno-221-1)[tool.uv.pip]
[#__codelineno-221-2](#__codelineno-221-2)prerelease = "allow"
...
```
[#__codelineno-222-1](#__codelineno-222-1)[pip]
[#__codelineno-222-2](#__codelineno-222-2)prerelease = "allow"
...
```
[#__codelineno-223-1](#__codelineno-223-1)[tool.uv.pip]
[#__codelineno-223-2](#__codelineno-223-2)python = "3.10"
...
```
[#__codelineno-224-1](#__codelineno-224-1)[pip]
[#__codelineno-224-2](#__codelineno-224-2)python = "3.10"
...
```
[#__codelineno-225-1](#__codelineno-225-1)[tool.uv.pip]
[#__codelineno-225-2](#__codelineno-225-2)python-platform = "x86_64-unknown-linux-gnu"
...
```
[#__codelineno-226-1](#__codelineno-226-1)[pip]
[#__codelineno-226-2](#__codelineno-226-2)python-platform = "x86_64-unknown-linux-gnu"
...
```
[#__codelineno-227-1](#__codelineno-227-1)[tool.uv.pip]
[#__codelineno-227-2](#__codelineno-227-2)python-version = "3.8"
...
```
[#__codelineno-228-1](#__codelineno-228-1)[pip]
[#__codelineno-228-2](#__codelineno-228-2)python-version = "3.8"
...
```
[#__codelineno-229-1](#__codelineno-229-1)[tool.uv.pip]
[#__codelineno-229-2](#__codelineno-229-2)reinstall = true
...
```
[#__codelineno-230-1](#__codelineno-230-1)[pip]
[#__codelineno-230-2](#__codelineno-230-2)reinstall = true
...
```
[#__codelineno-231-1](#__codelineno-231-1)[tool.uv.pip]
[#__codelineno-231-2](#__codelineno-231-2)reinstall-package = ["ruff"]
...
```
[#__codelineno-232-1](#__codelineno-232-1)[pip]
[#__codelineno-232-2](#__codelineno-232-2)reinstall-package = ["ruff"]
...
Hash-checking mode is all or nothing. If enabled, _all _requirements must be provided with a corresponding hash or set of hashes. Additionally, if enabled, _all _requirements must either be pinned to exact versions (e.g., `==1.0.0 `), or be specified via direct URL. 
...
```
[#__codelineno-233-1](#__codelineno-233-1)[tool.uv.pip]
[#__codelineno-233-2](#__codelineno-233-2)require-hashes = true
...
```
[#__codelineno-234-1](#__codelineno-234-1)[pip]
[#__codelineno-234-2](#__codelineno-234-2)require-hashes = true
...
```
[#__codelineno-235-1](#__codelineno-235-1)[tool.uv.pip]
[#__codelineno-235-2](#__codelineno-235-2)resolution = "lowest-direct"
...
```
[#__codelineno-236-1](#__codelineno-236-1)[pip]
[#__codelineno-236-2](#__codelineno-236-2)resolution = "lowest-direct"
...
```
[#__codelineno-237-1](#__codelineno-237-1)[tool.uv.pip]
[#__codelineno-237-2](#__codelineno-237-2)strict = true
...
```
[#__codelineno-238-1](#__codelineno-238-1)[pip]
[#__codelineno-238-2](#__codelineno-238-2)strict = true
...
```
[#__codelineno-239-1](#__codelineno-239-1)[tool.uv.pip]
[#__codelineno-239-2](#__codelineno-239-2)system = true
...
```
[#__codelineno-240-1](#__codelineno-240-1)[pip]
[#__codelineno-240-2](#__codelineno-240-2)system = true
...
```
[#__codelineno-241-1](#__codelineno-241-1)[tool.uv.pip]
[#__codelineno-241-2](#__codelineno-241-2)target = "./target"
...
```
[#__codelineno-242-1](#__codelineno-242-1)[pip]
[#__codelineno-242-2](#__codelineno-242-2)target = "./target"
...
```
[#__codelineno-243-1](#__codelineno-243-1)[tool.uv.pip]
[#__codelineno-243-2](#__codelineno-243-2)torch-backend = "auto"
...
```
[#__codelineno-244-1](#__codelineno-244-1)[pip]
[#__codelineno-244-2](#__codelineno-244-2)torch-backend = "auto"
...
```
[#__codelineno-245-1](#__codelineno-245-1)[tool.uv.pip]
[#__codelineno-245-2](#__codelineno-245-2)universal = true
...
```
[#__codelineno-246-1](#__codelineno-246-1)[pip]
[#__codelineno-246-2](#__codelineno-246-2)universal = true
...
```
[#__codelineno-247-1](#__codelineno-247-1)[tool.uv.pip]
[#__codelineno-247-2](#__codelineno-247-2)upgrade = true
...
```
[#__codelineno-248-1](#__codelineno-248-1)[pip]
[#__codelineno-248-2](#__codelineno-248-2)upgrade = true
...
```
[#__codelineno-249-1](#__codelineno-249-1)[tool.uv.pip]
[#__codelineno-249-2](#__codelineno-249-2)upgrade-package = ["ruff"]
...
```
[#__codelineno-250-1](#__codelineno-250-1)[pip]
[#__codelineno-250-2](#__codelineno-250-2)upgrade-package = ["ruff"]
...
```
[#__codelineno-251-1](#__codelineno-251-1)[tool.uv.pip]
[#__codelineno-251-2](#__codelineno-251-2)verify-hashes = true
...
```
[#__codelineno-252-1](#__codelineno-252-1)[pip]
[#__codelineno-252-2](#__codelineno-252-2)verify-hashes = true
