...
[#__codelineno-7-13](#__codelineno-7-13)requires = ["uv_build>=0.9.27,<0.10.0"]
...
[#__codelineno-8-13](#__codelineno-8-13)requires = ["uv_build>=0.9.27,<0.10.0"]
...
[#__codelineno-12-10](#__codelineno-12-10)requires = ["uv_build>=0.9.27,<0.10.0"]
