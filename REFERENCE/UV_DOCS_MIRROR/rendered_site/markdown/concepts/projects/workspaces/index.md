...
[#__codelineno-1-14](#__codelineno-1-14)requires = ["uv_build>=0.9.27,<0.10.0"]
...
[#__codelineno-2-15](#__codelineno-2-15)requires = ["uv_build>=0.9.27,<0.10.0"]
...
[#__codelineno-4-11](#__codelineno-4-11)requires = ["uv_build>=0.9.27,<0.10.0"]
