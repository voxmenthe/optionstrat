...
```
[#__codelineno-2-1](#__codelineno-2-1)$ curl -LsSf https://astral.sh/uv/0.9.27/install.sh | sh
...
```
[#__codelineno-4-1](#__codelineno-4-1)PS> powershell -ExecutionPolicy ByPass -c "irm https://astral.sh/uv/0.9.27/install.ps1 | iex"
